...
public class ControllerList {
    ...
    @RequestMapping("/bai2/list")
    public String bai2List(Model model) {
        model.addAttribute("list", getStaffList());
        return "bai2-list";
    }

    @RequestMapping("/bai4/list-status")
    public String bai4ListStatus(Model model) {
        model.addAttribute("list", getStaffList());
        return "bai4-list-status";
    }

    @RequestMapping("/bai5/list-controls")
    public String bai5ListControls(Model model) {
        model.addAttribute("list", getStaffList());
